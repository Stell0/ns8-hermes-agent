...
- The settings page is now agent-focused plus shared Open WebUI publishing. Keep it focused on one shared `base_virtualhost` field plus listing agents, creating and editing agents, deleting agents, and toggling start or stop state.
